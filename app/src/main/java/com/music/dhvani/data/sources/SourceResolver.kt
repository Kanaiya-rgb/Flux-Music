package com.music.dhvani.data.sources
...
object SourceResolver {
    ...
    fun requestForNow(): StreamRequest {
        ...
        return when (ceiling) {
            AudioQuality.LOSSLESS -> StreamRequest.Lossless
    ...
    /**
     * @param uri a `flux://source?...` URI as built by [SourceRegistry.trackUri].
     ...
     * [toMediaItem][com.music.dhvani.playback.toMediaItem].
     */
     ...
     * playback as `flux://watch?v=…` and never passes through [resolve].
     ...
     * [StreamChoice][com.music.dhvani.playback.StreamChoice] before caching a
     ...
     * plays lossy for the rest of its length, because [QualityUpgrade][com.music.dhvani.playback.QualityUpgrade]
     ...
     * directly — see
     * [resolveForDownload][com.music.dhvani.data.innertube.StreamResolver.resolveForDownload]
     ...
     *
     * [DownloadQuality.LOSSLESS][com.music.dhvani.data.settings.DownloadQuality.LOSSLESS]
     * and [DownloadQuality.HIGH][com.music.dhvani.data.settings.DownloadQuality.HIGH];
     * not [DownloadQuality.STANDARD][com.music.dhvani.data.settings.DownloadQuality.STANDARD].
     ...
     * the live lookup [QualityUpgrade][com.music.dhvani.playback.QualityUpgrade]
     ...
     * [AudioCache][com.music.dhvani.playback.AudioCache] decide how to treat
